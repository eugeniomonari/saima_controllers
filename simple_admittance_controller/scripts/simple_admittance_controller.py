...
move_to_ready = rospy.get_param('/simple_admittance_controller_node/move_to_ready')
...
load_controller('simple_admittance_controller')
...
switch_controller = rospy.ServiceProxy('/controller_manager/switch_controller', SwitchController)
start = []
stop = ['simple_admittance_controller']
switch_controller(start, stop, 2, start_asap, timeout)
