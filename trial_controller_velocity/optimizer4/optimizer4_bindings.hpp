...
static const uintptr_t OPTIMIZER4_NUM_DECISION_VARIABLES = 8;

/// Number of parameters
static const uintptr_t OPTIMIZER4_NUM_PARAMETERS = 83;

/// Number of parameters associated with augmented Lagrangian
static const uintptr_t OPTIMIZER4_N1 = 0;

/// Number of penalty constraints
static const uintptr_t OPTIMIZER4_N2 = 14;

/// optimizer4 version of ExitStatus
/// Structure: `optimizer4ExitStatus`
enum class optimizer4ExitStatus {
...
///
struct optimizer4Cache;

/// optimizer4 version of AlmOptimizerStatus
/// Structure: `optimizer4SolverStatus`
///
struct optimizer4SolverStatus {
  /// Exit status
  optimizer4ExitStatus exit_status;
...
optimizer4Cache *optimizer4_new();
...
optimizer4SolverStatus optimizer4_solve(optimizer4Cache *instance,
                                        double *u,
                                        const double *params,
                                        const double *y0,
                                        const double *c0);
...
/// # Safety
/// All arguments must have been properly initialised
void optimizer4_free(optimizer4Cache *instance);
