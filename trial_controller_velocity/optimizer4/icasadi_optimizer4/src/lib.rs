...
//!
//! Generated at: 2024-07-05 12:36:52.375992
//!

// #![no_std]

/// Number of static parameters (this also includes penalty constraints)
const NUM_STATIC_PARAMETERS: usize = 83;

/// Number of decision variables
const NUM_DECISION_VARIABLES: usize = 8;
...
pub fn mapping_f1(
    ...
    unsafe {
         mapping_f1_function_optimizer4(
            arguments.as_ptr(),
...
pub fn mapping_f2(
    ...
    unsafe {
         mapping_f2_function_optimizer4(
            arguments.as_ptr(),
            constraints.as_mut_ptr()
        ) as i32
    }
