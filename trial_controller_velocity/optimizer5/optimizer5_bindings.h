 ...
 */
#define OPTIMIZER5_NUM_DECISION_VARIABLES 2

/**
 * Number of parameters
 */
#define OPTIMIZER5_NUM_PARAMETERS 83

/**
 * Number of parameters associated with augmented Lagrangian
 */
#define OPTIMIZER5_N1 0

/**
 * Number of penalty constraints
 */
#define OPTIMIZER5_N2 14

/**
 * optimizer5 version of ExitStatus
 * Structure: `optimizer5ExitStatus`
 */
typedef enum optimizer5ExitStatus {
  /**
...
} optimizer5ExitStatus;

/**
 * Solver cache (structure `optimizer5Cache`)
 *
 */
typedef struct optimizer5Cache optimizer5Cache;
 ...
 *
 */
typedef struct optimizer5SolverStatus {
  /**
   * Exit status
   */
  enum optimizer5ExitStatus exit_status;
  /**
 ...
 */
struct optimizer5Cache *optimizer5_new(void);
 ...
 */
struct optimizer5SolverStatus optimizer5_solve(struct optimizer5Cache *instance,
                                               double *u,
                                               const double *params,
                                               const double *y0,
                                               const double *c0);
 ...
 * All arguments must have been properly initialised
 */
void optimizer5_free(struct optimizer5Cache *instance);
