...
//!
//! Generated at: 2024-07-05 13:17:56.207705
//!
...
const NUM_DECISION_VARIABLES: usize = 2;
...
extern "C" {
    fn cost_function_optimizer5(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double) -> c_int;
    fn grad_cost_function_optimizer5(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double)
        -> c_int;
    fn mapping_f1_function_optimizer5(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double,
    ) -> c_int;
    fn mapping_f2_function_optimizer5(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double,
    ) -> c_int;
} // END of extern C
...
pub fn mapping_f1(
    ...
    unsafe {
         mapping_f1_function_optimizer5(
            arguments.as_ptr(),
...
pub fn mapping_f2(
    ...
    unsafe {
         mapping_f2_function_optimizer5(
            arguments.as_ptr(),
            constraints.as_mut_ptr()
        ) as i32
    }
