...
//!
//! Generated at: 2024-07-05 12:37:17.071155
//!

// #![no_std]

/// Number of static parameters (this also includes penalty constraints)
const NUM_STATIC_PARAMETERS: usize = 75;
...
extern "C" {
    fn cost_function_optimizer2(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double) -> c_int;
    fn grad_cost_function_optimizer2(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double)
        -> c_int;
    fn mapping_f1_function_optimizer2(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double,
    ) -> c_int;
    fn mapping_f2_function_optimizer2(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double,
    ) -> c_int;
} // END of extern C
...
pub fn mapping_f1(
    ...
    unsafe {
         mapping_f1_function_optimizer2(
            arguments.as_ptr(),
...
pub fn mapping_f2(
    ...
    unsafe {
         mapping_f2_function_optimizer2(
            arguments.as_ptr(),
            constraints.as_mut_ptr()
        ) as i32
    }
