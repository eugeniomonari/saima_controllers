 ...
 */
#define OPTIMIZER2_NUM_DECISION_VARIABLES 8

/**
 * Number of parameters
 */
#define OPTIMIZER2_NUM_PARAMETERS 75

/**
 * Number of parameters associated with augmented Lagrangian
 */
#define OPTIMIZER2_N1 0

/**
 * Number of penalty constraints
 */
#define OPTIMIZER2_N2 14

/**
 * optimizer2 version of ExitStatus
 * Structure: `optimizer2ExitStatus`
 */
typedef enum optimizer2ExitStatus {
  /**
...
} optimizer2ExitStatus;

/**
 * Solver cache (structure `optimizer2Cache`)
 *
 */
typedef struct optimizer2Cache optimizer2Cache;
 ...
 *
 */
typedef struct optimizer2SolverStatus {
  /**
   * Exit status
   */
  enum optimizer2ExitStatus exit_status;
  /**
 ...
 */
struct optimizer2Cache *optimizer2_new(void);
 ...
 */
struct optimizer2SolverStatus optimizer2_solve(struct optimizer2Cache *instance,
                                               double *u,
                                               const double *params,
                                               const double *y0,
                                               const double *c0);
 ...
 * All arguments must have been properly initialised
 */
void optimizer2_free(struct optimizer2Cache *instance);
